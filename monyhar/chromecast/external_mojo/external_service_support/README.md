...
in processes outside of Monyhar/cast_shell. The simplest model is to create a
...
The 'MonyharServiceWrapper' class is intended to allow Mojo services that were
...
'CreateMonyharServiceReceiver()' to create a
...
communicate with each other without any Monyhar embedder on the system.
