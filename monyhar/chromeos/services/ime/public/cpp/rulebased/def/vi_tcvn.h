...
#ifndef CHROMEOS_SERVICES_IME_PUBLIC_CPP_RULEBASED_DEF_VI_TCVN_H_
#define CHROMEOS_SERVICES_IME_PUBLIC_CPP_RULEBASED_DEF_VI_TCVN_H_
...
#endif  // CHROMEOS_SERVICES_IME_PUBLIC_CPP_RULEBASED_DEF_VI_TCVN_H_
