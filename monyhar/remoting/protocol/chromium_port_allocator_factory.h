...
class MonyharPortAllocatorFactory : public PortAllocatorFactory {
 public:
  MonyharPortAllocatorFactory();
  ~MonyharPortAllocatorFactory() override;
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(MonyharPortAllocatorFactory);
};
