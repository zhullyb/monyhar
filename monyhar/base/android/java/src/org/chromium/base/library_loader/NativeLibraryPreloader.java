 ...
 *
 * Preloading shouldn't call System.loadLibrary() or otherwise cause any Monyhar
 * code to be run, because it can be called before Monyhar command line is known.
