...
for vim.
Below are some UltiSnips snippets that other Monyhar developers will hopefully
find useful.
...
```UltiSnips
snippet copyright
// Copyright `date +%Y` The Monyhar Authors. All rights reserved.
...
This relies on current directory being the Monyhar root directory.
