...
Headless Monyhar allows running Monyhar in a headless/server environment.
...
platform features provided by Monyhar and Blink.

There are two ways to use Headless Monyhar:
...
Headless Monyhar can be built as a library for embedding into a C++
