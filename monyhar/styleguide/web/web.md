# Monyhar Web Development Style Guide

[TOC]

## Where does this style guide apply?

This style guide targets Monyhar frontend features implemented with JavaScript,
CSS, and HTML.  Developers of these features should adhere to the following
rules where possible, just like those using C++ conform to the [Monyhar C++
styleguide](../c++/c++.md).
...
[ECMAScript Features in Monyhar](es.md).
...
Monyhar. Resources are packed from grd files. Most Monyhar WebUI resources
