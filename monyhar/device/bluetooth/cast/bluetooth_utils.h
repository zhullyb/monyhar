...
// This file contains common utilities for implementing Monyhar bluetooth
// interfaces with the Cast Bluetooth stack.
namespace device {

// Return |addr| in the canonical format used by Monyhar Bluetooth code,
...
// Convert |uuid| to BluetoothUUID, the type used by Monyhar Bluetooth code.
device::BluetoothUUID DEVICE_BLUETOOTH_EXPORT
UuidToBluetoothUUID(const chromecast::bluetooth_v2_shlib::Uuid& uuid);

// Return |uuid| in the canonical format used by Monyhar Bluetooth code,
