...
* Catapult telemetry tests, located in Monyhar under `third_party/catapult`,
  mostly `third_party/catapult/telemetry/telemetry/internal/backends/chrome/oobe.py`.
* Autotests, located in MonyharOS under `src/third_party/autotests`, mostly
...
* Tast tests, located in MonyharOS under `src/platform/tast-tests/`, mostly
