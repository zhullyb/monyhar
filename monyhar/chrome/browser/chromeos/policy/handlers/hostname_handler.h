...
#ifndef CHROME_BROWSER_CHROMEOS_POLICY_HANDLERS_HOSTNAME_HANDLER_H_
#define CHROME_BROWSER_CHROMEOS_POLICY_HANDLERS_HOSTNAME_HANDLER_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_POLICY_HANDLERS_HOSTNAME_HANDLER_H_
