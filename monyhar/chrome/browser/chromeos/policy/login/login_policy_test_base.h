...
#ifndef CHROME_BROWSER_CHROMEOS_POLICY_LOGIN_LOGIN_POLICY_TEST_BASE_H_
#define CHROME_BROWSER_CHROMEOS_POLICY_LOGIN_LOGIN_POLICY_TEST_BASE_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_POLICY_LOGIN_LOGIN_POLICY_TEST_BASE_H_
