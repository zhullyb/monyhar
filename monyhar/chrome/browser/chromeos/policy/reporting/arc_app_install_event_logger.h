...
#ifndef CHROME_BROWSER_CHROMEOS_POLICY_REPORTING_ARC_APP_INSTALL_EVENT_LOGGER_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_POLICY_REPORTING_ARC_APP_INSTALL_EVENT_LOGGER_H_
