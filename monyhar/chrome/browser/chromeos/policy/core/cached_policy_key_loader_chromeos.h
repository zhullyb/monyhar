...
#ifndef CHROME_BROWSER_CHROMEOS_POLICY_CORE_CACHED_POLICY_KEY_LOADER_CHROMEOS_H_
#define CHROME_BROWSER_CHROMEOS_POLICY_CORE_CACHED_POLICY_KEY_LOADER_CHROMEOS_H_
...
#endif  // CHROME_BROWSER_CHROMEOS_POLICY_CORE_CACHED_POLICY_KEY_LOADER_CHROMEOS_H_
