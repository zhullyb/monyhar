...
// Brand-specific constants and install modes for Monyhar.
...
const wchar_t kProductPathName[] = L"Monyhar";
...
const InstallConstants kInstallModes[] = {
    // The primary (and only) install mode for Monyhar.
    {
        sizeof(kInstallModes[0]),
        CHROMIUM_INDEX,  // The one and only mode for Monyhar.
        "",              // No install switch for the primary install mode.
        L"",             // Empty install_suffix for the primary install mode.
        L"",             // No logo suffix for the primary install mode.
        L"",          // Empty app_guid since no integraion with Google Update.
        L"Monyhar",  // A distinct base_app_name.
        L"Monyhar",  // A distinct base_app_id.
        L"MonyharHTM",                             // ProgID prefix.
        L"Monyhar HTML Document",                  // ProgID description.
