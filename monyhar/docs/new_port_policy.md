...
Since every new port for Monyhar has a maintenance cost, here are some guidelines for when the project will accept a new port.
...
*   Monyhar engineers are not expected to maintain them.
