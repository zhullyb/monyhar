...
Sublime can be used on Linux, Windows and Mac as an IDE for developing Monyhar.
Here's what works:
...
Here are some settings that help match the Monyhar style guide:
```
{
  // Basic Monyhar style preferences
  "rulers": [80],
  "tab_size": 2,
...
Once you have a copy of the Monyhar checkout, we'll make a new Sublime project
...
### Code Linting with CPPLint (Monyhar only)

**Note:** CPPLint enforces the Google/Monyhar style guide, and hence is not
...
### Format Selection with Clang-Format (Monyhar only)

**Note:** Like CPPLint, Clang-format enforces the Google/Monyhar style guide,
...
## CodeSearch Integration with Monyhar X-Refs

With [Monyhar X-Refs](https://github.com/karlinjf/MonyharXRefs/) you can
...
More information on Monyhar X-Ref's functionality (including keyboard and
mouse shortcuts) can be found on the [Monyhar X-Refs
page](https://github.com/karlinjf/MonyharXRefs/).
...
compilation errors on save. It works with Monyhar with a script that finds and
